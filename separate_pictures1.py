...
import time
starttime = time.mktime(time.strptime('2018-8-1 12:00:00', '%Y-%m-%d %H:%M:%S'))


for i in dirlist:
    if int(i[4:14])>1533095103 and int(i[4:14])<1534777261:
        img = cv2.imread(i)
        ...
        pts1 = np.array([[136,86],[591,65],[141,377],[576,402]])
        ...
        cv2.imwrite('C://Users//xxx//Desktop//smartfarm_data//panel1//'+i[4:14]+'.jpg',res2)
        ...
        cv2.imwrite('C://Users//xxx//Desktop//smartfarm_data//panel1_seg//area_'+datenum+'.jpg',output)
