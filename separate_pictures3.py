...
for i in dirlist:
    if int(i[5:15])>1533110404 and int(i[5:15])<1534795231:
        img = cv2.imread(i)
        ...
        pts1 = np.array([[80,116],[482,90],[85,437],[534,385]]) 
        ...
        cv2.imwrite('C://Users//xxx//Desktop//smartfarm_data//panel3//'+i[5:15]+'.jpg',res2)
        ...
        cv2.imwrite('C://Users//xxx//Desktop//smartfarm_data//panel3_seg//area_'+datenum+'.jpg',output)
